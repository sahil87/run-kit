 ...
 *  starfield planes. Sheet/pseudo flairs render the bare span.
 *
 *  DRAG GUARD: cube/warp animate transforms on those child spans, which would
 *  corrupt the HTML5 drag ghost (the row transform ban — see
 *  .rk-scanlines-crawl). The uniform guard hides the overlay for EVERY flair
...
export function FlairOverlay({ flair, hidden }: { flair: string | undefined; hidden?: boolean }) {

---
description: "Component conventions; modal dialogs and popup surfaces including the spring-loaded marker pad and the GUI off-confirm (with the settings-seam gui.enabled off-interception and the per-viewer rk-gui-view/rk-gui-lock postures); clipboard and e2e host-state rules; the Zustand window store, optimistic mutation feedback, and recently-closed mirror."
type: memory
---

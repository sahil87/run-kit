...
// the pair of verbs behind the @rk_pane_agent_state pane option. `setup` installs the
...
var agentCmd = &cobra.Command{
	...
	Long: "Agent instrumentation: `setup` installs the agent-harness hooks that " +
		"write the " + tmux.AgentStateOption + " tmux pane option (so run-kit can show any " +

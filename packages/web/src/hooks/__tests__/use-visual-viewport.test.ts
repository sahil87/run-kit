...
describe("useVisualViewport", () => {
  ...
  it("updates --app-offset-top when viewport scrolls", () => {
    ...
    mockVV.dispatchEvent(new Event("scroll"));
    flushRaf();
    expect(document.documentElement.style.getPropertyValue("--app-offset-top")).toBe("42px");
  });
  ...
  it("removes --app-height, --app-offset-top and listeners on unmount", () => {
    ...
    expect(document.documentElement.style.getPropertyValue("--app-offset-top")).toBe("");

...
describe("SwatchPopover", () => {
  ...
  describe("banded Label picker", () => {
    ...
    it("the flair band lists the 13 states in display order, rain/scan leading", () => {
      renderLabelPicker();
      const cells = Array.from(
  ...
  describe("keyboard navigation (plain-grid bands)", () => {
    ...
    it("the marker row walks all 8 states; the flair rows walk 7 and 6 columns (rain/nyan/… over scan/naruto/…)", () => {
      ...
      // (7) clamps to col 6 on the 7-wide flair row (portal).
      arrow("ArrowDown", 2);
      enter();
      expect(onSelectFlair).toHaveBeenLastCalledWith("portal");

...
- [ ] [29qz] 2026-04-03: Add CmdK options to move a the current window to the next or previous window (move window left or right). Also allow doing this by dragging the window on the left pane
- [ ] [dq70] 2026-04-03: Add CmdK options to move a window to another session. Also allow this by dragging the window out of the current session into another session

...
var (
	...
	flairTokens  = []string{"rain", "scan", "nyan", "naruto", "onepiece", "pacman", "matrix", "aquarium", "roadrunner", "invaders", "cube", "warp", "spidey", "duel"}
)
...
// invaders/cube/warp/spidey/duel). Returns an empty string if valid, an error
// message otherwise. The single shared flair-value rule reused by the window-option

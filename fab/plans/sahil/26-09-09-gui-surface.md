...
| D7 | **Resize policy**: the desktop follows the **last-focused fine-pointer viewer's** tile size via SetDesktopSize; other viewers scale client-side; **coarse-pointer viewers never drive resize**; palette `GUI: Lock resolution` pins it. HiDPI renders 1× by default — **amended by V1** (`gui.geometry`; the follow is now the `auto` value): see [`26-09-10-gui-viewer-ergonomics.md`](26-09-10-gui-viewer-ergonomics.md) | study §7 |
...
| G1–G3 | *(child plan — the desktop leg and the agent verbs)* see [`26-09-10-gui-desktop.md`](26-09-10-gui-desktop.md) | C5 merged | M/S/M | | | tracked in the child plan |
| V1–V4 | *(child plan — fixed geometry, zoom, touch pointer modes, quality presets, toolbar; amends D7)* see [`26-09-10-gui-viewer-ergonomics.md`](26-09-10-gui-viewer-ergonomics.md) | G3 merged | M/M/S/M | | | tracked in the child plan |

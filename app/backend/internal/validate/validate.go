...
var (
	...
	flairTokens  = []string{"rain", "scan", "nyan", "naruto", "onepiece", "pacman", "matrix", "aquarium", "roadrunner", "invaders", "cube", "warp", "portal"}
)
...
// invaders/cube/warp/portal). Returns an empty string if valid, an error message

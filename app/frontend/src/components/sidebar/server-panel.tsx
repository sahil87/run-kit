    ...
    <CollapsiblePanel
      ...
      headerAction={
        <button
          ...
          className="text-text-secondary hover:text-text-primary transition-colors text-[13px] px-1 min-w-[24px] min-h-[24px] coarse:min-w-[40px] coarse:min-h-[40px] -my-1 coarse:-my-3 flex items-center justify-center"
        >
          +
        </button>
      }

...
- [ ] [qeuz] 2026-03-03: while typing an input - is there a way to overcome the latency? Make user input super smooth
- [ ] [bj8j] 2026-03-03: can reserve the bottom bar for input - Ctrl, Alt, Cmd, Fn keys etc

...
| [Marker 3×3 Studies](../wiki/marker-3x3-studies.html) | Canonical final-state study for the window-row marker well, the 3×3 marker pad, shade semantics, interaction states, and dark/light ink behavior. Self-contained; open in a browser |
| [Marker Axis Studies](../wiki/marker-axis-studies.html) | Iteration trail for marker-category treatments, stage encoding, and row integration explored before the canonical 3×3 design. Self-contained; open in a browser |
| [Mode Axis Studies](../wiki/mode-axis-studies.html) | Iteration trail for automatic/manual mode distinctions and their visual relationship to category and stage. Self-contained; open in a browser |
...
| [Window Row Studies](../wiki/window-row-studies.html) | Iteration trail for reclaiming the row's left zone, aligning content, and separating the marker well from fine- and coarse-pointer actions. Self-contained; open in a browser |

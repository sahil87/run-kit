  ...
  return (
    <div ref={containerRef} className="relative inline-flex items-center">
      <button
        ...
        onClick={toggle}
        className={triggerClassName ?? "text-text-secondary hover:text-text-primary transition-colors min-w-[24px] min-h-[24px] coarse:min-w-[36px] coarse:min-h-[36px] flex items-center justify-center"}
      >
        {icon ?? "\u25BE"}
      </button>
      {open && (

...
var (
	...
	flairTokens  = []string{"rain", "scan", "nyan", "naruto", "onepiece", "pacman", "matrix", "aquarium", "roadrunner", "invaders", "cube", "warp", "spidey", "custom"}
)
...
// invaders/cube/warp/spidey/custom). Returns an empty string if valid, an error message

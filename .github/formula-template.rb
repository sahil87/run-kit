...
class Rk < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/wvrdz/run-kit/releases/download/v#{version}/rk-darwin-arm64.tar.gz",
          using: GitHubPrivateReleaseDownloadStrategy
      sha256 "SHA_DARWIN_ARM64"
    else
      url "https://github.com/wvrdz/run-kit/releases/download/v#{version}/rk-darwin-amd64.tar.gz",
          using: GitHubPrivateReleaseDownloadStrategy
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/wvrdz/run-kit/releases/download/v#{version}/rk-linux-arm64.tar.gz",
          using: GitHubPrivateReleaseDownloadStrategy
      sha256 "SHA_LINUX_ARM64"
    else
      url "https://github.com/wvrdz/run-kit/releases/download/v#{version}/rk-linux-amd64.tar.gz",
          using: GitHubPrivateReleaseDownloadStrategy
